...
async function getEmbedParamsForSingleReport(workspaceId, reportId, additionalDatasetId) {
    ...
    // const reportInGroupApi = `https://api.powerbi.com/v1.0/myorg/groups/${workspaceId}/dashboards/cab7260b-a457-45d4-a880-e4f83d60796d`;
    // cab7260b-a457-45d4-a880-e4f83d60796d
    ...
    resultJson.embedUrl = resultJson.embedUrl + "&filter=Swine_User_Authorization/Email eq 'chutima_jit@cpf.co.th'";
...
async function getEmbedTokenForSingleReportSingleWorkspace(reportId, datasetIds, targetWorkspaceId) {
    ...
    //Report NO_RLS Not Require
    // // Add Identities (userName as servicePricipleObjectId)
    // // "identities": [
    // //     {
    // //       "username": "4bb2f11a-98a6-4eb7-ba4c-32ddbf243d2e",
    // //       "datasets": [
    // //         "f4379356-24bd-46e7-bab2-3717aef02e6b"
    // //       ],
    // //        "roles": [
    // //         "admin"
    // //       ]
    ...
    //     'username': "4bb2f11a-98a6-4eb7-ba4c-32ddbf243d2e",
    //     "roles":["embededSPGroup"],
    //     "datasets":!!formData.datasets ? formData.datasets.map(p=>p.id): []
    // })

        // // Add for dashboard id in the request
        // let formData = {
        //     "accessLevel": "View"
        // };
    ...
    // let dashboardId='cab7260b-a457-45d4-a880-e4f83d60796d';
    // const embedTokenApi = `https://api.powerbi.com/v1.0/myorg/groups/${workspaceId}/dashboards/${dashboardId}/GenerateToken`;
